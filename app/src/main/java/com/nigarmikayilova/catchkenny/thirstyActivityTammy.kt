...
class thirstyActivityTammy : AppCompatActivity() {
    private lateinit var binding:ActivityThirstyTammyBinding
    var score=0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityThirstyTammyBinding.inflate(layoutInflater)
        ...
        object:CountDownTimer(30000,1000){
            ...
            override fun onFinish() {
                ...
                val alert=AlertDialog.Builder(this@thirstyActivityTammy)
                ...
                alert.setPositiveButton("Yes"){p0,p1->
                    ...
                    Toast.makeText(this@thirstyActivityTammy,"Restarting game!", Toast.LENGTH_LONG).show()
                    this.start()


                }
                alert.setNegativeButton("No"){ p0,p1 ->
                    Toast.makeText(this@thirstyActivityTammy,"Exit game!",Toast.LENGTH_LONG).show()
                    val intent= Intent(this@thirstyActivityTammy,PlayActivity::class.java)
