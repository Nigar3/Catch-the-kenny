...
import com.nigarmikayilova.catchkenny.databinding.ActivityNinetyTammyBinding
...
class NinetyActivityTammy : AppCompatActivity() {
    private lateinit var binding:ActivityNinetyTammyBinding
    var score=0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding=ActivityNinetyTammyBinding.inflate(layoutInflater)
        ...
        object:CountDownTimer(90000,1000){
            ...
            override fun onFinish() {
                ...
                val alert=AlertDialog.Builder(this@NinetyActivityTammy)
                ...
                alert.setPositiveButton("Yes"){p0,p1->
                    ...
                    Toast.makeText(this@NinetyActivityTammy,"Restarting game!", Toast.LENGTH_LONG).show()
                    this.start()


                }
                alert.setNegativeButton("No"){ p0,p1 ->
                    Toast.makeText(this@NinetyActivityTammy,"Exit game!",Toast.LENGTH_LONG).show()
                    val intent= Intent(this@NinetyActivityTammy,PlayActivity::class.java)
