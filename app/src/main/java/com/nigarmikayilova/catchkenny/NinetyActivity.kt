...
import com.nigarmikayilova.catchkenny.databinding.ActivityNinetyBinding
...
class NinetyActivity : AppCompatActivity() {
    val imageviews= ArrayList<ImageView>()

    private lateinit var binding:ActivityNinetyBinding
    var score=0
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        binding=ActivityNinetyBinding.inflate(layoutInflater)
        ...
        object:CountDownTimer(90000,1000){
            ...
            override fun onFinish() {
                ...
                val alert=AlertDialog.Builder(this@NinetyActivity)
                ...
                alert.setPositiveButton("Yes"){p0,p1->
                    ...
                    Toast.makeText(this@NinetyActivity,"Restarting game!", Toast.LENGTH_LONG).show()
                    this.start()


                }
                alert.setNegativeButton("No"){ p0,p1 ->
                    Toast.makeText(this@NinetyActivity,"Exit game!",Toast.LENGTH_LONG).show()
                    val intent= Intent(this@NinetyActivity,PlayActivity::class.java)
